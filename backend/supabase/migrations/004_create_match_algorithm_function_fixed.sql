-- ============================================
-- MATCH ALGORITHM FUNCTION (MongoDB ObjectId Compatible)
-- ============================================
...
COMMENT ON FUNCTION find_matches IS 'Advanced matching algorithm based on destination, interests, languages, and academic info. Compatible with MongoDB ObjectId.';
